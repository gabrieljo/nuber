...
export interface GetNearByRideReponse {
  ok: boolean;
  error: string | null;
  ride: Ride | null;
}
...
export interface RideStatusSubscriptionSubscriptionArgs {
  rideId: number;
}
